...
```json
{
  "compilerOptions": {
    ...
    "paths": {
      ...
      "@@fe-app/haptap-web/*": ["apps/frontend/haptap/web/src/*"],
      "@@fe-app/haptap-mobile/*": ["apps/frontend/haptap/mobile/src/*"],
      "@@be-app/haptap/*": ["apps/backend/haptap/src/*"]
    }
  }
}
```
