import { SortDirection } from '@@be-haptap/app/models/sort-direction';
import { CreateProductDto } from '@@be-haptap/app/products/dto/create-product.dto';
import { ProductQueryParamsDto } from '@@be-haptap/app/products/dto/product-query-params.dto';
import { ProductsSearchResponseDto } from '@@be-haptap/app/products/dto/products-search-response.dto';
import { UpdateProductDto } from '@@be-haptap/app/products/dto/update-product.dto';
